...
public class GiftCard 
{
	public static void main(String[] args) throws InterruptedException
	{
		...
		String[] str={"Kairvi","kairvibalana@gmail.com","kair","kairvibalana@gmail.com"};
		...
		{
		System.out.println("I am on GiftCard Page");
		...
		driver.findElement(By.id("giftcard_2_Message")).sendKeys("kairvi is a good girl");
		...
		if(verify_product.isDisplayed())
		{
			...
			System.out.println("Adding the product is unsuccessful");
		}
		else
		{
			System.out.println("I am not on GiftCard page");
			driver.close();
		}
	}
}	